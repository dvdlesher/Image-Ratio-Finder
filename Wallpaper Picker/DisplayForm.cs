...
namespace Wallpaper_Picker
{
    public partial class DisplayForm : Form
    {
        ...
        public DisplayForm(List<MatchedImages> matchedImages, Form prevForm, string previewSize)
        {
            InitializeComponent();
        ...
        private void populateGalleryLayout(int thumbnailSize)
        {
            ...
            {
                flowGalleryLayout.Controls.Add(new ThumbnailLayout(ThumbnailMaker.makeThumb(Image.FromFile(matchedImages[i].getfullPath()), thumbnailSize, thumbnailSize, true)));
            }
        }
